...
//input eh um tipo generico para que a calculadora funcione com qualquer numero de entrada
template <typename input>

//classe que contem as operacoes e metodos necessarios para a operacao da calculadora
class Calculadora
{
    public:
        //construtor generico de um objeto da classe Calculadora
        Calculadora();
        //construtor que inicia realizando uma operacao com um operando
        Calculadora(char operation, std::string numberA);
        //construtor que inicia realizando uma operacao com dois operandos
        Calculadora(char operation, std::string numberA, std::string numberB);
